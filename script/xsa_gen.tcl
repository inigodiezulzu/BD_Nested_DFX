...
\
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_reset  [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins reconfig_inst_0/rst]
  connect_bd_net -net reconfig_inst_0_lower  [get_bd_pins reconfig_inst_0/lower] [get_bd_ports lower_out]
  connect_bd_net -net reconfig_inst_0_upper  [get_bd_pins reconfig_inst_0/upper] [get_bd_ports upper_out]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0  [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins reconfig_inst_0/gclk]

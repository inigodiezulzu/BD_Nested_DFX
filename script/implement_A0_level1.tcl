...
set_property SCOPED_TO_CELLS {floorplan_static_i/reconfig_inst_0/inst} [get_files ../synthesis/reconfig_shifters.dcp]
...
link_design -mode default -reconfig_partitions {floorplan_static_i/reconfig_inst_0/inst} -part $part -top floorplan_static_wrapper > $loc/top_link_design.log
...
update_design -black_box -cell floorplan_static_i/reconfig_inst_0/inst

...
if { [get_files reconfig_inst.v] == "" } {
  import_files -quiet -fileset sources_1 ../source/hdl/reconfig_inst.v
}
...
# reconfig_inst
  ...
  # Create ports
  set upper_out [ create_bd_port -dir O -from 3 -to 0 upper_out ]
  set lower_out [ create_bd_port -dir O -from 3 -to 0 lower_out ]
...
\
 ...
 # Create port connections
  connect_bd_net -net proc_sys_reset_0_peripheral_reset  [get_bd_pins proc_sys_reset_0/peripheral_aresetn] \
  [get_bd_pins reconfig_inst_0/rst]
  connect_bd_net -net reconfig_inst_0_lower  [get_bd_pins reconfig_inst_0/lower] \
  [get_bd_ports lower_out]
  connect_bd_net -net reconfig_inst_0_upper  [get_bd_pins reconfig_inst_0/upper] \
  [get_bd_ports upper_out]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0  [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] \
  [get_bd_pins proc_sys_reset_0/slowest_sync_clk] \
  [get_bd_pins reconfig_inst_0/gclk]
...
if { [get_property IS_LOCKED [ get_files -norecurse floorplan_static.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../source/hdl/floorplan_static_wrapper.v" ]
} else {
...
write_hw_platform -fixed -force -file ./prj/floorplan_static.vitis/floorplan_static_wrapper.xsa
